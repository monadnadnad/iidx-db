<template>
  <div>
    ...
    <p v-else-if="chartPending">
      Loading...
    </p>
    <div v-else>
      <h1 data-test="song-title">
        {{ chartData?.title }}
      </h1>
      <p
        v-if="chartData"
      ...
      >
        ...
        <input
          v-if="canInputLaneText"
          v-model="recommendationForm.laneText"
          maxlength="7"
          placeholder="lane"
        />
        <input
          v-model="recommendationForm.comment"
          maxlength="255"
          placeholder="comment"
        />
        <button
      ...
      <ul data-test="recommendation-list">
        ...
        <li v-if="recommendationsPending">
